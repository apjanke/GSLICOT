...
C             If N > 0, an estimate of the reciprocal of the condition
C             number (in the 1-norm) of the N-th order system of
C             algebraic equations from which the solution matrix X is
C             obtained.
C
